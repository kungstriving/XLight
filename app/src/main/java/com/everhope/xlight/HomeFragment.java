...
//        int cellHeight = cellWidth;
        ...
        for (int i = 0; i < sceneCount; i++) {
            ...
            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(cellWidth, cellWidth);   //same width height
            currentLineLayout.addView(button, layoutParams);
            currentLineCount++;
        }
